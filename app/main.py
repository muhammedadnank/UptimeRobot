...
from app.core.db import init_db, get_user, upsert_user, delete_user
...
def _register_core_handlers(client: Client):
    ...
    async def cmd_start(c: Client, message: Message):
        if await check_all(c, message):
            return
        from app.handlers.callbacks import main_keyboard
...
def main():
    ...
    async def _run():
        ...
        from app.handlers import monitors, account, contacts, mwindow, psp, callbacks, admin, inline
